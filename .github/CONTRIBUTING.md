# Contributing to the Symphony Java Sample Bots
...
As a result, PRs submitted to the symphony-java-sample-bots project cannot be accepted until you have a CLA in place with the Foundation.

# Contributing Issues

## Prerequisites

* [ ] Have you [searched for duplicates](https://github.com/symphonyoss/symphony-java-sample-bots/issues?utf8=%E2%9C%93&q=)?  A simple search for exception error messages or a summary of the unexpected behaviour should suffice.
* [ ] Are you running the [latest release of the symphony-java-sample-bots](https://github.com/symphonyoss/symphony-java-sample-bots/commits/master)?

## Raising an Issue
* Create your issue [here](https://github.com/symphonyoss/symphony-java-sample-bots/issues/new).
 ...
 * For documentation contributions, follow the general structure, language, and tone of the [existing docs](https://github.com/symphonyoss/symphony-java-sample-bots/blob/master/README.md).
 ...
 * If necessary (e.g. due to 3rd party dependency licensing requirements), update the [NOTICE file](https://github.com/symphonyoss/symphony-java-sample-bots/blob/master/NOTICE) with any new attribution or other notices
